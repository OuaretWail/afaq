...
import { ChapterAttachmentForm } from "./_components/chapter-attachement-form";
...
const ChapterIdPage = async ({
  ...
  const chapter = await db.chapter.findUnique({
    where: {
      id: chapterId, // Use directly
      courseId: courseId, // Use directly
    },
    include: {
      muxData: true,
    },
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-16">
          ...
          <div className="space-y-4">
            ...
            <div className="">
              <ChapterAttachmentForm courseId={courseId} chapterId={chapterId} />
            </div>
          </div>
        </div>
      </div>
